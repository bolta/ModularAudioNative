...
unary_calc!(CosCalc, |arg: Sample| arg.cos());
unary_calc!(TanCalc, |arg: Sample| arg.tan());
unary_calc!(AbsCalc, |arg: Sample| arg.abs());
unary_calc!(SignumCalc, |arg: Sample| arg.signum());
unary_calc!(FloorCalc, |arg: Sample| arg.floor());
unary_calc!(CeilCalc, |arg: Sample| arg.ceil());
unary_calc!(RoundCalc, |arg: Sample| arg.round());
unary_calc!(TruncCalc, |arg: Sample| arg.trunc());
